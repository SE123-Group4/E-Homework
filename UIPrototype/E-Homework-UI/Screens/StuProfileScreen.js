//my profile screen (for students)
...
export function Profile_studentPage({navigation}) {
  return (
    <View style={{flex: 1}}>
      <Container>
        <Card>
        ...
        <Card>
          <CardItem style={styles.profileIconStyle}>
            ...
            <Icon name="graduation-cap" size={30} color="#52C0FE" />
        ...
        <Button
          ...
          onPress={() => {
            navigation.navigate('TeaProfileScreen');
          }}
          title="测试转老师"
        />
      </Container>
