...
import {Container, Text, Icon, Left,Right,Content,Card,CardItem,Button,Col, Row, Grid} from 'native-base';
                            ...
                            <CardItem style={{backgroundColor:'#1FA0FC',height:120}}>
                                <Left>
                                    <Button iconLeft rounded style={{backgroundColor:'white'}}>
                                        ...
                                        <Text style={{fontSize:30,color:'#0786E0'}}>{month}月{date}日</Text>
                                    </Button>
                                </Left>
                                <Right>
