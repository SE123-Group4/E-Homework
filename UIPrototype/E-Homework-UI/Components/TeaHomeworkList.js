...
export class TeaHomeworkList extends React.Component {
    constructor() {
        ...
        this.state = {
            homework: [
                {title: '作业 1', post: '2020-09-28', ddl: '2020-10-10', finished:20,unfinished:24},
                {title: '作业 2', post: '2020-09-28', ddl: '2020-10-10', finished:21,unfinished:23},
                {title: '作业 3', post: '2020-09-28', ddl: '2020-10-10', finished:22,unfinished:22},
                {title: '作业 4', post: '2020-09-28', ddl: '2020-10-10', finished:23,unfinished:21},
                {title: '作业 5', post: '2020-09-28', ddl: '2020-10-10', finished:24,unfinished:20},
            ],
        };
    }
